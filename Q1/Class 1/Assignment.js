...
var MyName = "Arsalan Sajjad Touqeer";
...
// Allama Iqbal once said, “A person who never made a mistake never tried anything new.”
...
// Program written by [Arsalan Sajjad Touqeer]
// Date: [7/24/2023]
// Store a person’s name in a variable
var personName = "Arsalan Sajjad Touqeer";
// Compose a personalized message using the person's name
var message = `My Name is ${personName}, i'm a software devoloper.`;
// Print the personalized message
console.log(message);
// **********************************************************
// Task 11
// Names: Store the names of a few of your friends in a array called names. Print each person’s name by accessing each element in the list, one at a time.
var names = ["John", "Vick", "Charlie", "David"];
...
for (var i = 0; i < names.length; i++) {
    console.log(message + names[i] + ", how are you?");
}
// **********************************************************
// Task 13
// Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”
var transportationModes = ["Honda motorcycle", "Audi Car", "BMW motorcycle", "Ford truck"];
...
var guestList = ["John", "Mark", "Smith"];
for (var i = 0; i < guestList.length; i++) {
    console.log(`Dear ${guestList[i]}, you are cordially invited to dinner at my place. Please let me know if you can attend.`);
}
// **********************************************************
// Task 15
...
var guestList = ["John", "Mark", "Smith"];
var unavailableGuest = "John";
var newGuest = "Bob Smith";
// Find the index of the unavailable guest
var indexOfUnavailableGuest = guestList.indexOf(unavailableGuest);
...
var guestList = ["Bob Smith", "Mark", "Smith"];
var maxGuests = 2;
...
var locations = ["Tokyo", "Paris", "Sydney", "Rome", "New York"];
...
var landmarks = ["Eiffel Tower", "Great Wall of China", "Machu Picchu", "Taj Mahal", "Pyramids of Giza"];
console.log(landmarks);
// **********************************************************
// Task 21
// They think of something you could store in a TypeScript Object. Write a program that creates Objects containing these items.
var person = {
    name: "Arsalan Sajjad Touqeer",
    age: 26,
...
var usernames = ["admin", "Eric", "John", "Jane", "Alice"];
...
var current_users = ["John", "Emma", "David", "Sophia", "Alex"];
var new_users = ["Emma", "Olivia", "Daniel", "sophia", "Michael"];
for (var new_user of new_users) {
    var is_username_taken = current_users.some((current_user) => current_user.toLowerCase() === new_user.toLowerCase());
...
function show_magiciansss(names) {
    for (var name of names) {
        console.log(name);
    }
}
